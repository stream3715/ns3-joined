...
class Fib : noncopyable {
 ...
 public:  // mutation
   ...
   * components. \return the entry, and true for new entry or false for existing
   * entry
   */
   ...
   *
   *  If a NextHop record for \p face already exists in \p entry, its cost is
   * set to \p cost.
   */
 ...
 public:  // enumeration
   ...
   *  \warning Undefined behavior may occur if a
